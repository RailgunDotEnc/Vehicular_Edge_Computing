...
# ============================================================================
#Code imports
from settings import RESNETTYPE, NUM_USERS, EPOCHS, LOCAL_EP, FRAC, LR, TRAINING_SORCE, ATTACKERS
...
def run(Global,net_glob_client,net_glob_server, device, dataset_train,dataset_test,dict_users,dict_users_test,TcArray,TsArray):
    ...
    for iter in range(EPOCHS):
        ...
        for idx in idxs_users:
            ...
            # Training ------------------
            if ATTACKERS == True and str(idxs_users[idx]) in LIST_LF_ATTACKERS:
                ...
                local.data_transform(dict_users_copy, local.target_label)
