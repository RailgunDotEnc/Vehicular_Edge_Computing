...
if True:
    ...
    #                         Data loading 
    #=============================================================================    
    df = pd.read_csv(r'D:\MST_AI\SplitFed-When-Federated-Learning-Meets-Split-Learning\data\HAM10000_metadata.csv')
    print(df.head())
    ...
    imageid_path = {os.path.splitext(os.path.basename(x))[0]: x
                    for x in glob(os.path.join(r"D:\MST_AI\SplitFed-When-Federated-Learning-Meets-Split-Learning\data", '*', '*.jpg'))}
