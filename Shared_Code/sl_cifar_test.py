# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 10:54:40 2023
...
from sl_test import Baseblock, ResNet18_client_side, ResNet18_server_side, ResNetType, img_type, num_channels

def ClientModel():
    print("Generating model")
    client = ResNet18_client_side()
    return client

def ServerModel():
    server = ResNet18_server_side(block, num_layers, classes)
    return server
